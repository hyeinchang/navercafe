...
CREATE TABLE project_members (
    ...
    user_detail_addr    varchar2(100)    NULL,
...
CREATE TABLE project_board (
    ...
    board_reply_allow    char(1)        DEFAULT 'Y',

...
<div class="container mt-5 mb-5" style="font-weight: bold; font-size: 20px;">
	<h1><b>회원가입</b></h1>
	<form action="register" method="post" name="signupForm">
		<div class="mb-3">
		...
		<div class="mb-3">
			...
			<input type="text" name="addr1" readonly id="addr1" class="form-control">
			<input type="text" name="addr2" placeholder="주소" readonly id="addr2" class="form-control">
			<input type="text" name="addr3" placeholder="상세 주소" id="addr3" class="form-control">
		</div>
		<div class="mb-3">
		...
		<div class="mt-4 text-end">
			...
			<button type="button" class="btn btn-primary" style="font-weight: bold;" onclick="reg()">회원가입</button>
		</div>
	</form>
</div>
